...
for s = 1:length(spectrum), j = 1:length(gRange)
    ...
    for b in 1:length(betaRange), i in 1:length(lambdaRange)
        ...
        writeln(io,"julia --project=/home/sliang/JuliaCode/mycMPO /home/sliang/JuliaCode/mycMPO/NNLS_TFIsing.jl --g $(g) --beta $(beta) --lambda $(lambda) --spectrum $(spec) --wmin $(wmin)")
        close(io)
